...
public class Client {
    ...
    private ClueLessClientMinimal cg;
     ...
     */
    Client(String server, int port, String username, ClueLessClientMinimal cg) {
        this.server = server;
        this.port = port;
    ...
    public boolean start() {
        ...
        // will send as a String. All other messages will be GameMessage objects
        try {
