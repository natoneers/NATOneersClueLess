...
public class ClueLessClientMinimal extends javax.swing.JFrame {
    ...
    private void jtbLoginActionPerformed(java.awt.event.ActionEvent evt) {                                         
    ...
    private void jbCurrentPlayersActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        client.sendMessage(new GameMessage(GameMessage.WHOISIN, ""));
        return;
    }                                                

    private void jtfTestMessageActionPerformed(java.awt.event.ActionEvent evt) {                                               
        if (connected) {
    ...
    private void jbSuggestionActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    private void jtbStartGameActionPerformed(java.awt.event.ActionEvent evt) {                                             
        this.playerNum=jcbPlayer.getSelectedIndex();
        this.playerName=jcbPlayer.getItemAt(this.playerNum);
        String message = this.playerName + " has joined the game.";
        client.sendMessage(new GameMessage(GameMessage.JOIN, message));
        jtbStartGame.setEnabled(false);
    }                                            
